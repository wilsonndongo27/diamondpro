...
Route::get('/list-staff', [listController::class, 'listStaffMethod'])->name('list-staff'); 
Route::get('/list-partner', [listController::class, 'listPartnerMethod'])->name('list-partner'); 
Route::get('/list-achievement', [listController::class, 'listAchievementMethod'])->name('list-achievement'); 
