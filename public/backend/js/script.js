...
$(document).ready(function(){
    ...
    quillvision = new Quill('.editor-vision-update', {
        theme: 'snow',
        modules: {
            toolbar: {
                container: toolbarOptions,
...
var postSubmitVision = function(){
    editor = document.querySelector(".editor-vision");
    contentInput = document.querySelector(".post-content-vision");
    contentInput.value = editor.innerHTML;
}
...
var postSubmitUpdateVision = function(){
    editor = document.querySelector(".editor-vision-update");
    contentInput = document.querySelector(".post-content-vision-update");
    contentInput.value = editor.innerHTML;
}
