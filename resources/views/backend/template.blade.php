...
<head>
    ...
    <title>Diamond Pro - Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b>Diamond Pro</b> Admin</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="@if (Auth::user()->pp)
                  {{asset ('storage/'.Auth::user()->pp) }}
                @else
                  {{asset ('images/user-default.jpeg') }}  @endif" 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Services & Produits</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route ('product')}}">Services & Produits</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <footer class="main-footer">
    ...
    </div>Copyright &copy; <span class="copydate"></span> <a href="">Diamond Pro</a>. All Rights Reserved.
  </footer>
