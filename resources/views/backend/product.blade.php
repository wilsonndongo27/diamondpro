...
<div class="col-12">
    <div class="box">
        <div class="box-header headerpage">
            <div class="col-lg-8">
                <h3 class="box-title">Liste des Produits & Services</h3>
            </div>
            <div class="col-md-4">
                    ...
                    @else
                        <tr >
                            <td colspan="7" class="text-primary text-center" >
                                <p class="emptylist">Aucun produit enregistré pour l'instant!</p>
                            </td>
                        </tr>
                    @endif
                </tbody>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header row">
                    ...
                    <h4 class="col-lg-7 modal-title">Ajouter un Produit/Service</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating">
                                    <input class="form-control"  name="title" required placeholder="titre du produit/service..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
    ...
    <div id="updateProductModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header row">
                    <img class="col-lg-2 logoform" src="{{asset('images/logomini.jpeg')}}"/>
                    <h4 class="col-lg-7 modal-title">Modifier ce Produit/Service</h4>
                    <button type="button" class="col-lg-2 close" data-dismiss="modal">&times;</button>
                </div>
