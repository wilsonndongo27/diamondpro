...
<div class="col-12">
    <div class="box">
        <div class="box-header headerpage">
            ...
            <div class="col-md-4">
                <i class="fa fa-plus-circle addbtn" id="newnews"></i>
            </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item statusForm" href="javascript:void()"
                                                data-id="{{$item->id}}"
                                                data-message="Le status de cette actualité sera mis à jour!"
                                                data-type="warning"
                                                data-url="{{ route ('status-news')}}"
                                                data-token="{{csrf_token()}}">
                                                <i class="fa fa-ban"></i> Activer/Désactiver</a>
                                            <a class="dropdown-item" href="javascript:void()" id="updatenews"
                                                data-id="{{ $item->id }}"
                                            ...
                                            <a class="dropdown-item deleteForm" 
                                                ...
                                                data-id="{{$item->id}}"
                                                data-message="Cette actualité sera supprimer!"
                                                data-type="warning"
                    ...
                    @else
                        <tr >
                            <td colspan="7" class="text-primary text-center" >
                                <p class="emptylist">Aucune actualité enregistré pour l'instant!</p>
                            </td>
                        </tr>
                    @endif
                </tbody>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header row">
                    ...
                    <h4 class="col-lg-7 modal-title">Ajouter une Actualité</h4>
                    <button type="button" class="col-lg-2 close" data-dismiss="modal">&times;</button>
                </div>
                <form class="" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmission()" action="{{ route ('create-news')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating">
                                    <input class="form-control"  name="title" required placeholder="titre de la actualité..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p>Titre</p>
                                <div class="form-group label-floating">
                                    <input class="form-control"  name="title" id="newstitle" placeholder="titre de l'actualité..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p>Libellé</p>
                                <div class="form-group label-floating">
                                    <input type="text" class="form-control" id="newslabel"  name="label" placeholder="Libellé..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-xs-12" >
                                <img src="" alt="" class="updateimage" id="newscover">
                            </div>
                            <div class="col-lg-6 col-md-12 col-xs-12" >
                                <p>Image de l'actualité</p>
                                <div class="form-group label-floating" >
