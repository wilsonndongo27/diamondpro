...
<div class="box">
    ...
    <table id="articles-table" class="table shadow-card">
        @if ($company ?? '')
            <tr>
                <td colspan="12" class="text-primary text-left infocompanyview" >
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12 BlockInfo">
            ...
            <tr >
                <td colspan="12" class="text-primary text-left infocompanyview">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12 BlockInfo">
                            <p>Vision : <span class="valuetextent">{!! html_entity_decode($company->vision) !!}</span></p>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <div id="companyModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form class="" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmission(); postSubmitVision();" action="{{ route('create-company')}}">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating">
                                    <div class="form-group label-floating">
                                        <div class="editor-vision" style="height:20vh">
                                        </div>
    ...
    <div id="updateCompanyModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form class="updateform" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmissionUpdate(); postSubmitUpdateVision();" action="{{ route('update-company')}}">
                    <div class="modal-body">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating">
                                    <div class="form-group label-floating">
                                        <div class="editor-vision-update" style="height:20vh">
                                        </div>
                                        <input class="form-control post-content-vision-update" name="vision" type="hidden"/>
                                    </div>
                                </div>
                            </div>
                        </div>
