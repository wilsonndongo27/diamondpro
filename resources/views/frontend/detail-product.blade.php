...
@section('body')
	<!-- Start main-content -->
	<section class="page-title" style="background-image: url({{asset('storage/'.$product->cover)}});">
				...
				<div class="col-xl-12 col-lg-12">
					<div class="blog-details__left">
						<div class="blog-details__content">
							<h3 class="blog-details__title">{{$product->label}}</h3>
							<div class="blockcontenttext">
								<p class="blog-details__text-2">{!! html_entity_decode($product->description) !!}</p>
							</div>
						</div>
